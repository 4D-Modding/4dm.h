...
namespace fdm 
{
	...
	public:
		...
		{
			return reinterpret_cast<bool (__fastcall*)(const std::string& filename, int cols, int rows)>(getFuncAddr((int)Func::ResourceManager::loadArrayTexture))(filename, cols, rows);
		}
	};
}

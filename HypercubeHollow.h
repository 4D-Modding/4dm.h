...
namespace fdm 
{
	...
	public:
		...
		{
			return reinterpret_cast<int (__thiscall*)(HypercubeHollow* self, int buffIndex, int attrIndex)>(FUNC_HYPERCUBEHOLLOW_ATTRSIZE)(this, buffIndex, attrIndex);
		}
		int attrStride(int buffIndex, int attriIdex) override
		{
			return reinterpret_cast<int (__thiscall*)(HypercubeHollow* self, int buffIndex, int attriIdex)>(FUNC_HYPERCUBEHOLLOW_ATTRSTRIDE)(this, buffIndex, attriIdex);
		}

...
namespace fdm 
{
	...
	public:
		...
		{
			glm::vec4 result;
			reinterpret_cast<glm::vec4 (__thiscall*)(EntitySpider* self, glm::vec4* result)>(FUNC_ENTITYSPIDER_GETPOS)(this, &result);
			return result;
		}
		...
		{
			std::string result;
			reinterpret_cast<std::string (__thiscall*)(EntitySpider* self, std::string* result)>(FUNC_ENTITYSPIDER_GETNAME)(this, &result);
			return result;
		}
		...
		nlohmann::json saveAttributes() override
		{
			...
			reinterpret_cast<nlohmann::json (__thiscall*)(EntitySpider* self, nlohmann::json* result)>(FUNC_ENTITYSPIDER_SAVEATTRIBUTES)(this, &result);
			return result;
		}
